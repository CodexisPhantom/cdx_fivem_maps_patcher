...
namespace CodeWalker.World
{
    ...
    public class Ped
    {
        ...
        public void Init(MetaHash pedhash, GameFileCache gfc)
        {
            ...
            uint ycdhash = JenkHash.GenHash(initdata.ClipDictionaryName.ToLowerInvariant());
            uint yedhash = JenkHash.GenHash(initdata.ExpressionDictionaryName.ToLowerInvariant());
            ...
            uint exprhash = JenkHash.GenHash(initdata.ExpressionName.ToLowerInvariant());
        ...
        {
            MCPedVariationInfo vi = Ymt?.VariationInfo;
            if (vi != null)
            {
                ...
                if (compData?.DrawblData3 != null)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        string texn = item?.GetTextureName(tex);
