    ...
    public class Frustum
    {
        ...
        public bool ContainsAABBNoClip(ref Vector3 cen, ref Vector3 e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                float r = (e.X * (pn.X > 0 ? pn.X : -pn.X)) + (e.Y * (pn.Y > 0 ? pn.Y : -pn.Y)) + (e.Z * (pn.Z > 0 ? pn.Z : -pn.Z)); //Vector3.Dot(e, pn.Abs()); //
        ...
        public bool ContainsAABBNoClipNoOpt(ref Vector3 bmin, ref Vector3 bmax)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                float r = (e.X * (pn.X > 0 ? pn.X : -pn.X)) + (e.Y * (pn.Y > 0 ? pn.Y : -pn.Y)) + (e.Z * (pn.Z > 0 ? pn.Z : -pn.Z));
