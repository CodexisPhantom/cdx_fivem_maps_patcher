...
namespace CodeWalker.GameFiles
{
    ...
    public class TextureDictionary : ResourceFileBase
    {
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            ...
            TextureNameHashes = reader.ReadBlock<ResourceSimpleList64_uint>();
            Textures = reader.ReadBlock<ResourcePointerList64<Texture>>();
        ...
        public static void WriteXmlNode(TextureDictionary d, StringBuilder sb, int indent, string ddsfolder,
            string name = "TextureDictionary")
        {
            if (d == null) return;
        ...
        public static TextureDictionary ReadXmlNode(XmlNode node, string ddsfolder)
        {
            ...
            TextureDictionary td = new TextureDictionary();
        ...
        public void BuildFromTextureList(List<Texture> textures)
        {
            ...
            foreach (Texture tex in textures) texturehashes.Add(tex.NameHash);
    ...
    public class TextureBase : ResourceSystemBlock
    {
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            if (reader.IsGen9)
            {
                ...
                if (!string.IsNullOrEmpty(Name)) NameHash = JenkHash.GenHash(Name.ToLowerInvariant());
            ...
            else
            {
                ...
                NamePointer = reader.ReadUInt64();
                Unknown_30h = reader.ReadUInt16();
                Unknown_32h = reader.ReadUInt16();
        ...
        public virtual void ReadXml(XmlNode node, string ddsfolder)
        {
            ...
            Unknown_32h = (ushort)Xml.GetChildUIntAttribute(node, "Unk32");
            ...
            ExtraFlags = Xml.GetChildUIntAttribute(node, "ExtraFlags");
        }
        ...
        public void EnsureGen9()
        {
            ...
            if (G9_Flags == 0)
            {
                ...
                if (Name?.ToLowerInvariant()?.StartsWith("script_rt_") ?? false) G9_Flags = 0x00260228;
            }

            if (G9_Unknown_23h == 0 && istex) G9_Unknown_23h = 0x28; //TODO...

            if (G9_SRV == null)
            {
                G9_SRV = new ShaderResourceViewG9();
                G9_SRV.Dimension = ShaderResourceViewDimensionG9.Texture2D;
                if (Depth > 1) G9_SRV.Dimension = ShaderResourceViewDimensionG9.Texture2DArray;
        ...
        public int CalcDataSize()
        {
            ...
            DDSIO.DXGI_FORMAT dxgifmt = DDSIO.GetDXGIFormat(Format);
            int div = 1;
            int len = 0;
            for (int i = 0; i < Levels; i++)
            {
                ...
                DDSIO.DXTex.ComputePitch(dxgifmt, width, height, out int rowPitch, out int slicePitch, 0);
                len += slicePitch;
                div *= 2;
            }
        ...
        public TextureFormatG9 GetEnhancedFormat(TextureFormat format)
        {
            switch (format)
            {
                case 0: return TextureFormatG9.UNKNOWN;
        ...
        public static uint GetBlockCount(TextureFormatG9 f, uint width, uint height, uint depth, uint mips, uint flags,
            uint oldval = 0)
        {
    ...
    public class Texture : TextureBase
    {
        ...
        public long MemoryUsage
        {
            ...
            {
                long val = 0;
                if (Data != null) val += Data.FullData.LongLength;
                return val;
            }
        }
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            ...
            else
            {
                ...
                // read reference data
                Data = reader.ReadBlockAt<TextureData>(DataPointer, Format, Width, Height, Levels, Stride);
            }
        }
        ...
        public override void Write(ResourceDataWriter writer, params object[] parameters)
        {
            ...
            {
                DataPointer = (ulong)Data.FilePosition;
        ...
        public override void WriteXml(StringBuilder sb, int indent, string ddsfolder)
        {
            ...
            try
            {
                ...
                {
                    if (!Directory.Exists(ddsfolder)) Directory.CreateDirectory(ddsfolder);
        ...
        public override void ReadXml(XmlNode node, string ddsfolder)
        {
            ...
            Levels = (byte)Xml.GetChildUIntAttribute(node, "MipLevels");
    ...
    public enum TextureFormatG9 :
        uint //actually rage::sga::BufferFormat, something like DXGI_FORMAT, also used in drawables
    {
        UNKNOWN = 0x0,
