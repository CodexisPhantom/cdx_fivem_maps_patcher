...
namespace CodeWalker.GameFiles
{
    ...
    public static class MetaTypes
    {
                    ...
                    else
                    {
                        ...
                        if (entry.DataType == MetaStructureEntryDataType.Array)
                        {
                            ...
                            else
                            {
                                ...
                                string typename = "Array_" + MetaStructureEntryDataTypes.GetCSharpTypeName(structentry.DataType);
        ...
        public static string GetTypesInitString()
        {
            ...
            foreach (MetaStructureInfo si in StructDict.Values)
            {
                AddStructureInfoString(si, sb);
            }
            ...
            foreach (MetaEnumInfo ei in EnumDict.Values)
            {
                AddEnumInfoString(ei, sb);
            }
    ...
    [TC(typeof(EXP))] public class Mrage__phVerletClothCustomBounds : MetaWrapper
    {
        ...
        public override void Load(Meta meta, MetaPOINTER ptr)
        {
            ...
            rage__phCapsuleBoundDef[] cdata = MetaTypes.ConvertDataArray<rage__phCapsuleBoundDef>(meta, MetaName.rage__phCapsuleBoundDef, _Data.CollisionData);
            if (cdata != null)
            {
    ...
    [TC(typeof(EXP))] public class MCScenarioPointRegion : MetaWrapper
    {
        ...
        public void Load(Meta meta, CScenarioPointRegion data)
        {
            ...
            CScenarioEntityOverride[] entOverrides = MetaTypes.ConvertDataArray<CScenarioEntityOverride>(meta, MetaName.CScenarioEntityOverride, _Data.EntityOverrides);
            ...
            CScenarioPointCluster[] clusters = MetaTypes.ConvertDataArray<CScenarioPointCluster>(meta, MetaName.CScenarioPointCluster, _Data.Clusters);
            if (clusters != null)
            {
    ...
    [TC(typeof(EXP))] public class MCScenarioPointContainer : MetaWrapper
    {
        ...
        {
            CExtensionDefSpawnPoint[] vLoadSavePoints = MetaTypes.ConvertDataArray<CExtensionDefSpawnPoint>(meta, MetaName.CExtensionDefSpawnPoint, _Data.LoadSavePoints);
            ...
            CScenarioPoint[] vMyPoints = MetaTypes.ConvertDataArray<CScenarioPoint>(meta, MetaName.CScenarioPoint, _Data.MyPoints);
            if (vMyPoints != null)
            {
    ...
    [TC(typeof(EXP))] public class MCScenarioEntityOverride : MetaWrapper
    {
        ...
        public void Init(Meta meta)
        {
            ...
            CExtensionDefSpawnPoint[] scenarioPoints = MetaTypes.ConvertDataArray<CExtensionDefSpawnPoint>(meta, MetaName.CExtensionDefSpawnPoint, _Data.ScenarioPoints);
    ...
    [TC(typeof(EXP))] public class MCScenarioChainingGraph : MetaWrapper
    {
        ...
        public void Init(Meta meta)
        {
            CScenarioChainingNode[] pathnodes = MetaTypes.ConvertDataArray<CScenarioChainingNode>(meta, MetaName.CScenarioChainingNode, _Data.Nodes);
            if (pathnodes != null)
            {
            ...
            CScenarioChainingEdge[] pathedges = MetaTypes.ConvertDataArray<CScenarioChainingEdge>(meta, MetaName.CScenarioChainingEdge, _Data.Edges);
            if (pathedges != null)
            {
            ...
            CScenarioChain[] pathchains = MetaTypes.ConvertDataArray<CScenarioChain>(meta, MetaName.CScenarioChain, _Data.Chains);
            if (pathchains != null)
            {
        ...
        public bool RemoveNode(MCScenarioChainingNode n)
        {
            ...
            if (Edges != null)
            {
                ...
                foreach (MCScenarioChainingEdge edge in remedges)
                {
                    RemoveEdge(edge);
                }
            }
        ...
        public bool RemoveEdge(MCScenarioChainingEdge e)
        {
            ...
            if (Edges != null)
            {
                ...
                if (r)
                {
                    ...
                    foreach (MCScenarioChain c in remchains)
                    {
                        RemoveChain(c);
                    }
                }
    ...
    [TC(typeof(EXP))] public class MCPedVariationInfo : MetaWrapper
    {
        ...
        public void Load(Meta meta, CPedVariationInfo data)
        {
            ...
            CPVComponentData[] aComponentData3 = MetaTypes.ConvertDataArray<CPVComponentData>(meta, MetaName.CPVComponentData, _Data.aComponentData3);
            ...
            CPedSelectionSet[] vSelectionSets = MetaTypes.ConvertDataArray<CPedSelectionSet>(meta, MetaName.CPedSelectionSet, _Data.aSelectionSets);
            ...
            CComponentInfo[] vCompInfos = MetaTypes.ConvertDataArray<CComponentInfo>(meta, MetaName.CComponentInfo, _Data.compInfos);
            if (vCompInfos != null)
            {
    ...
    [TC(typeof(EXP))] public class MCPVComponentData : MetaWrapper
    {
        ...
        {
            CPVDrawblData[] aDrawblData3 = MetaTypes.ConvertDataArray<CPVDrawblData>(meta, MetaName.CPVDrawblData, _Data.aDrawblData3);
    ...
    [TC(typeof(EXP))] public class MCPedPropInfo : MetaWrapper
    {
        ...
        public MCPedPropInfo(Meta meta, CPedPropInfo data, MCPedVariationInfo owner)
        {
            ...
            CPedPropMetaData[] vPropMetaData = MetaTypes.ConvertDataArray<CPedPropMetaData>(meta, MetaName.CPedPropMetaData, _Data.aPropMetaData);
            ...
            CAnchorProps[] vAnchors = MetaTypes.ConvertDataArray<CAnchorProps>(meta, MetaName.CAnchorProps, _Data.aAnchors);
            if (vAnchors != null)
            {
