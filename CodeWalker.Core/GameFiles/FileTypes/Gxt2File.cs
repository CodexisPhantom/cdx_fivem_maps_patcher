...
namespace CodeWalker.GameFiles
{
    ...
    public class Gxt2File : PackedFile
    {
        ...
        public byte[] Save()
        {
            ...
            bw.Write(EntryCount);
            foreach (Gxt2Entry e in TextEntries)
            {
                e.Offset = offset;
                byte[] d = Encoding.UTF8.GetBytes(e.Text + "\0");
                datas.Add(d);
        ...
        public static Gxt2File FromText(string text)
        {
            ...
            List<Gxt2Entry> entries = new List<Gxt2Entry>();
