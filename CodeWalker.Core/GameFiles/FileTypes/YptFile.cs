...
namespace CodeWalker.GameFiles
{
    ...
    public class YptFile : GameFile, PackedFile
    {
        ...
        public byte[] Save()
        {
            DrawablePtfx[] drawables = PtfxList?.DrawableDictionary?.Drawables?.data_items;
        ...
        {
            ParticleEffectRuleDictionary pdict = PtfxList?.EffectRuleDictionary;
            ...
            if (pdict?.EffectRules?.data_items != null)
            {
                ...
                foreach (ParticleEffectRule e in pdict.EffectRules.data_items)
                {
