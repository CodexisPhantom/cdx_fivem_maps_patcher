    ...
    public class HeightmapFile : GameFile, PackedFile
    {
        ...
        private void Read(DataReader r)
        {
            ...
            if (Compressed > 0)
            {
                ...
                int h2off = dlen / 2; //is this right?
                for (int y = 0; y < Height; y++)
                {
                    CompHeader h = CompHeaders[y];
        ...
        private void Write(DataWriter w)
        {
            ...
            if (Compressed > 0)
            {
                CompHeader[] ch = new CompHeader[Height];
        ...
        public void ReadXml(XmlNode node)
        {
            ...
            {
                Endianess end = Endianess.BigEndian;
