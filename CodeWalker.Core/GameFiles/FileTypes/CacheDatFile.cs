...
namespace CodeWalker.GameFiles
{
    public class CacheDatFile : PackedFile
    {
        ...
        public void Load(byte[] data, RpfFileEntry entry)
        {
            ...
            List<CacheFileDate> dates = new List<CacheFileDate>();
            List<MapDataStoreNode> allMapNodes = new List<MapDataStoreNode>();
            List<CInteriorProxy> allCInteriorProxies = new List<CInteriorProxy>();
            List<BoundsStoreItem> allBoundsStoreItems = new List<BoundsStoreItem>();
            ...
            List<MapDataStoreNode> rootMapNodes = new List<MapDataStoreNode>();
